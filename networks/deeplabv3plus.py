...
class AtrousConvMobileNetV2(nn.Module):
    def __init__(self, in_channel=3, downsample_factor=8):
        ...
        model_path = Path(r"/home/yyt/PycharmProjects/examples/GAIC-Pytorch-main/networks/mobilenet_v2-b0353104.pth")
...
class UpsamplingDeepModule(nn.Module):
    def __init__(self):
        super(UpsamplingDeepModule, self).__init__()
        self.conv1 = nn.Conv2d(256, 512, kernel_size=4, stride=2, padding=1)
        self.conv2 = nn.Conv2d(512, 512, kernel_size=4, stride=2, padding=1)
...
class UpsamplingDeepModule_shufflenet(nn.Module):
    def __init__(self):
        super(UpsamplingDeepModule_shufflenet, self).__init__()
        self.conv1 = nn.Conv2d(256, 232, kernel_size=4, stride=2, padding=1)
        self.conv2 = nn.Conv2d(232, 232, kernel_size=4, stride=2, padding=1)
...
class UpsamplingDeepModule_mobile(nn.Module):
    def __init__(self):
        super(UpsamplingDeepModule_mobile, self).__init__()
...
class MyModel(nn.Module):
    def __init__(self):
        ...
        self.deeplab_model = DeepLabV3Plus(in_channel=3)
        self.upsample_module = UpsamplingDeepModule()
...
class MyModel_shufflenet(nn.Module):
    def __init__(self):
        super(MyModel_shufflenet, self).__init__()
        self.deeplab_model = DeepLabV3Plus(in_channel=3)
        self.upsample_module = UpsamplingDeepModule_shufflenet()
...
class MyModel_mobile(nn.Module):
    def __init__(self):
        super(MyModel_mobile, self).__init__()
        self.deeplab_model = DeepLabV3Plus(in_channel=3)
        self.upsample_module = UpsamplingDeepModule_mobile()
...
if __name__ == '__main__':
    model = MyModel_shufflenet()

    # 加载你的输入数据
    input_tensor1 = torch.randn(1, 3, 256, 384)
    input_tensor1 = torch.randn(1, 3, 256, 345)
